...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WINFN] = LAYOUT_60_iso(
        ...
        _______,    _______,    _______,    _______,    _______,    _______,    _______,    KC_DEL,     KC_END,     KC_PGDN,    RM_HUEU,    KC_UP,      MO(FNS),
    ...
    [MACFN] = LAYOUT_60_iso(
        ...
        _______,    _______,    KC_MUTE,    KC_VOLD,    KC_VOLU,    KC_MPRV,    KC_MNXT,    KC_DEL,     KC_END,     KC_PGDN,    RM_HUEU,    KC_UP,      MO(FNS),
        QK_BOOT,    _______,    _______,                                        _______,                                        KC_LEFT,    KC_DOWN,    KC_RIGHT,   _______
    ),
